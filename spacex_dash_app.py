...
def scatter(entered_site,payload):
    ...
    # thought reusing filter_df may cause issues, but tried it out of curiosity and it seems to be working fine
    ...
    if entered_site=='ALL':
        ...
        fig=px.scatter(filter_df[filter_df['Launch Site']==entered_site],x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f"Success count on payload mass for {entered_site}")
        return fig
